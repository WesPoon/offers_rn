...
public class FragmentThird extends Fragment implements OnTabChangeListener,OnPageChangeListener{
	
	
	private TabHost tabHost;
	private ViewPager viewPager;
	private MyFragmentPagerAdapter myViewPagerAdapter;
	private String[] tabname = {"Summer", "Mentor","Workshop"};
	int i = 0;
	View v;
	...
	public static FragmentThird newInstance(ActionBar MainActionBar) {
	...
	private void initializeViewPager() {
		...
		fragments.add(CommonFragment.newInstance(actionBar, Constants.summertrip));
		fragments.add(CommonFragment.newInstance(actionBar, Constants.mentorship));
		fragments.add(CommonFragment.newInstance(actionBar,Constants.workshop));
	...
	public void onDestroyView() {
		// TODO Auto-generated method stub
		Log.d("ThirdFragment","DestroyView");
		super.onDestroyView();
	}
	...
	public void onResume() {
		...
		Toast.makeText(getActivity(),"Fragment Third Resume",Toast.LENGTH_LONG).show();
