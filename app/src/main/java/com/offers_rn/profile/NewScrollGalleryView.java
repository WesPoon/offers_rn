 ...
 */
public class NewScrollGalleryView extends LinearLayout {
    ...
    public NewScrollGalleryView(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        inflater.inflate(R.layout.scroll_gallery_view_v2, this, true);

        horizontalScrollView = (HorizontalScrollView) findViewById(R.id.thumbnails_scroll_view);
        floatingActionButton = (FloatingActionButton) findViewById(R.id.scroll_gallery_sure);
    ...
    public NewScrollGalleryView setFragmentManager(FragmentManager fragmentManager) {
    ...
    public NewScrollGalleryView addMedia(MediaInfo mediaInfo) {
        if (mediaInfo == null) {
    ...
    public NewScrollGalleryView addMedia(List<MediaInfo> infos) {
        if (infos == null) {
            throw new NullPointerException("Infos may not be null!");
        }
     ...
     * @return
     */
    public NewScrollGalleryView setCurrentItem(int i) {
        viewPager.setCurrentItem(i, false);
        return this;
    }

    public NewScrollGalleryView setThumbnailSize(int thumbnailSize) {
        this.thumbnailSize = thumbnailSize;
        return this;
    }

    public NewScrollGalleryView setZoom(boolean zoomEnabled) {
        this.zoomEnabled = zoomEnabled;
        return this;
    }

    public NewScrollGalleryView hideThumbnails(boolean thumbnailsHiddenEnabled) {
